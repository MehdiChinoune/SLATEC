...
CONTAINS
  ...
  SUBROUTINE SFNCK(Lun,Kprint,Ipass)
    ...
    !
    REAL, PARAMETER :: v(105) = [ .834451800000000000000000000000E+09, &
      ...
      .193147180559945309417232121458E+00,  .111112222233333444440000000000E+00, &
      .314159265359000000000000000000E+01,  .998340790000000000000000000000E-01, &
      -.119476321700000000000000000000E+01,-.111112222233333444440000000000E+00, &
      .264665241200000000000000000000E+01, -.378671043061087976727207184637E+00, &
      ...
      .164493406684822643647241516665E+01,  .886226925452758013649083741687E+00, &
      -.314159265358979323846264338328E+01, .318309886183790671537767526733E+00, &
      ...
      .265625000000000000000000000000E+00,  .520499877813046537682746653770E+00, &
      .888388231701707764069578446749E+00,  .424436383502022295934042352455E+00, &
      .337000659742093423383019719632E+00, -.177596771314338304347397013056E+00, &
      .223890779141235668051827454628E+00, -.327579137591465222037734321812E+00, &
      .576724807756873387202448242187E+00,  .510375672649745119596606592612E+00, &
      -.308517625249033780073648984210E+00, .147863143391226844801050675510E+00, &
      -.107032431540937546888370772230E+00, .227958530233606726743720444020E+01, &
