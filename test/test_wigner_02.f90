...
CONTAINS
  ...
  SUBROUTINE DQC36J(Lun,Kprint,Ipass)
    ...
    !
    REAL(DP), PARAMETER :: r3jj(8) = [ 2.7888667551135851599272400859506249646427D-1, &
    ...
    !
    REAL(DP), PARAMETER :: r3jm(14) = [ 2.0915897328861524261384476677886072045904D-2, &
    ...
    !
    REAL(DP), PARAMETER :: r6j(15) = [ 3.4909051383732997774596981092927782159095D-2, &
