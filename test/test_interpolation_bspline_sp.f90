...
CONTAINS
  ...
  SUBROUTINE BSPCK(Lun,Kprint,Ipass)
    ...
    USE interpolation, ONLY : BFQAD, BINT4, BINTK, BSPDR, BSPEV, BSPPP, BSPVD, BSPVN, &
      BSQAD, BVALU, INTRV, PPQAD, PPVAL
    USE diff_integ, ONLY : PFQAD
    !     .. Scalar Arguments ..
    INTEGER :: Ipass, Kprint, Lun
    !     .. Local Scalars ..
    REAL(SP) :: atol, bquad, bv, den, dn, er, fbcl, fbcr, pi, &
      spv, tol, x1, x2, xl, xx
