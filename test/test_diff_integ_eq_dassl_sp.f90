...
CONTAINS
  ...
  !** SDJAC1
  PURE SUBROUTINE SDJAC1(T,Y,Yprime,Pd,Cj)
    ...
    REAL(SP), INTENT(IN) :: T, Y(:), Yprime(:), Cj
  ...
  !** SDJAC2
  PURE SUBROUTINE SDJAC2(T,Y,Yprime,Pd,Cj)
  ...
  !** SDRES1
  PURE SUBROUTINE SDRES1(T,Y,Yprime,Delta,Ires)
  ...
  !** SDRES2
  PURE SUBROUTINE SDRES2(T,Y,Yprime,Delta,Ires)
