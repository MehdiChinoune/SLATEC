...
CONTAINS
  ...
  SUBROUTINE CQCAI(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp, max_exp_sp
    USE special_functions, ONLY : CAIRY, CBIRY
    !
    !*Internal Notes:
  ...
  SUBROUTINE CQCBH(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp, max_exp_sp
    USE special_functions, ONLY : CBESH, CUOIK
  ...
  SUBROUTINE CQCBI(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp,  max_exp_sp
    USE special_functions, ONLY : CBESI, CBESK, CWRSK
    !
    !*Internal Notes:
    !   Machine constants are defined by functions I1MACH and R1MACH.
    !
  ...
  SUBROUTINE CQCBJ(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp, max_exp_sp
    USE special_functions, ONLY : CBESH, CBESJ
    !
    !*Internal Notes:
    !   Machine constants are defined by functions I1MACH and R1MACH.
    !
  ...
  SUBROUTINE CQCBK(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp, max_exp_sp
    USE special_functions, ONLY : CBESI, CBESK
    !
    !*Internal Notes:
    !   Machine constants are defined by functions I1MACH and R1MACH.
    !
  ...
  SUBROUTINE CQCBY(Lun,Kprint,Ipass)
    ...
    !
    USE service, ONLY : eps_sp, log10_radix_sp, min_exp_sp, max_exp_sp
    USE special_functions, ONLY : CBESI, CBESK, CBESY
    !
    !*Internal Notes:
    !   Machine constants are defined by functions I1MACH and R1MACH.
    !
