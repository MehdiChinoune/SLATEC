...
C***TYPE      SINGLE PRECISION (TEST18-S, TEST19-D, TEST20-C)
...
C        single precision Levels 2 and 3 BLAS routines
C
...
C***ROUTINES CALLED  I1MACH, SBLAT2, SBLAT3, XERMAX, XSETF, XSETUN
...
C
      ...
      ENDIF
C
C     Test single precision Level 2 BLAS routines
C
      CALL SBLAT2 (LUN, KPRINT, IPASS)
      IF (IPASS .EQ. 0) NFAIL = NFAIL + 1
C
C     Test single precision Level 3 BLAS routines
C
