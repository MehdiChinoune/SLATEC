...
C***BEGIN PROLOGUE  DCHK33
C***SUBSIDIARY
C***PURPOSE  Test DTRMM and DTRSM.
...
C***FIRST EXECUTABLE STATEMENT  DCHK33
      NARGS = 11
      NC = 0
      RESET = .TRUE.
      ERRMAX = ZERO
C     Set up zero matrix for DMMCH.
      DO 20 J = 1, NMAX
         DO 10 I = 1, NMAX
            C( I, J ) = ZERO
   10    CONTINUE
