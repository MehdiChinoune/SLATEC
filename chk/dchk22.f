...
C***BEGIN PROLOGUE  DCHK22
C***SUBSIDIARY
C***PURPOSE  Test DSYMV, DSBMV and DSPMV.
...
C     .. Data statements ..
      DATA               ICH/'UL'/
C***FIRST EXECUTABLE STATEMENT  DCHK22
      FULL = SNAME( 3: 3 ).EQ.'Y'
