...
C***BEGIN PROLOGUE  DCHK12
C***SUBSIDIARY
C***PURPOSE  Test DGEMV and DGBMV.
...
C     .. Data statements ..
      DATA               ICH/'NTC'/
C***FIRST EXECUTABLE STATEMENT  DCHK12
      FULL = SNAME( 3: 3 ).EQ.'E'
