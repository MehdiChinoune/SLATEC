*DECK SCHK23
     ...
     $   CS, CT, G)
C***BEGIN PROLOGUE  SCHK23
C***SUBSIDIARY
C***PURPOSE  Quick check for SSYMM.
...
C***FIRST EXECUTABLE STATEMENT  SCHK23
      NARGS = 12
C
      NC = 0
      RESET = .TRUE.
