*DECK TEST47
      PROGRAM TEST47
C***BEGIN PROLOGUE  TEST47
C***PURPOSE  Driver for testing SLATEC subprograms
C            CDRIV1  CDRIV2  CDRIV3
C***LIBRARY   SLATEC
C***CATEGORY  I1A2, I1A1B
C***TYPE      COMPLEX (TEST45-S, TEST46-D, TEST47-C)
...
C***ROUTINES CALLED  CDQCK, I1MACH, XERMAX, XSETF, XSETUN
C***REVISION HISTORY  (YYMMDD)
C   920801  DATE WRITTEN
C***END PROLOGUE  TEST47
      INTEGER IPASS, KPRINT, LIN, LUN, NFAIL
C***FIRST EXECUTABLE STATEMENT  TEST47
      LUN = I1MACH(2)
      LIN = I1MACH(1)
      NFAIL = 0
C
...
C
      ...
      ENDIF
      STOP
 9000 FORMAT (/' --------------TEST47 PASSED ALL TESTS----------------')
 9010 FORMAT (/' ************* WARNING -- ', I5,
     1        ' TEST(S) FAILED IN PROGRAM TEST47 *************')
      END
