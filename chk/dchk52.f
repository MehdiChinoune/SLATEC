*DECK DCHK52
     ...
     $   Y, YY, YS, YT, G, Z)
C***BEGIN PROLOGUE  DCHK52
C***SUBSIDIARY
C***PURPOSE  Quick check for DSYR and DSPR.
...
C     .. Data statements ..
      DATA               ICH/'UL'/
C***FIRST EXECUTABLE STATEMENT  DCHK52
      FULL = SNAME( 3: 3 ).EQ.'Y'
