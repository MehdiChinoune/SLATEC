*DECK CCHK13
     ...
     $   CS, CT, G)
C***BEGIN PROLOGUE  CCHK13
C***SUBSIDIARY
C***PURPOSE  Quick check for CGEMM.
...
C     .. Data statements ..
      DATA               ICH/'NTC'/
C***FIRST EXECUTABLE STATEMENT  CCHK13
      NARGS = 13
      NC = 0
      RESET = .TRUE.
      ERRMAX = RZERO
