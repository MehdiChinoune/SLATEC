...
C***BEGIN PROLOGUE  CCHK12
C***SUBSIDIARY
C***PURPOSE  Quick check for CGEMV and CGBMV.
...
C     .. Data statements ..
      DATA               ICH/'NTC'/
C***FIRST EXECUTABLE STATEMENT  CCHK12
      FULL = SNAME( 3: 3 ).EQ.'E'
