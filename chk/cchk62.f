*DECK CCHK62
     ...
     $   Y, YY, YS, YT, G, Z)
C***BEGIN PROLOGUE  CCHK62
C***SUBSIDIARY
C***PURPOSE  Quick check for CHER2 and CHPR2.
...
C     .. Data statements ..
      DATA               ICH/'UL'/
C***FIRST EXECUTABLE STATEMENT  CCHK62
      FULL = SNAME( 3: 3 ).EQ.'E'
