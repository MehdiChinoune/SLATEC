...
SUBROUTINE QK41(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  !
  REAL, PARAMETER :: xgk(21) = [ 0.9988590315882777E+00, 0.9931285991850949E+00, &
    ...
    0.0E+00 ]
  REAL, PARAMETER :: wgk(21) = [ 0.3073583718520532E-02, 0.8600269855642942E-02, &
  ...
  REAL, PARAMETER :: wg(10) = [ 0.1761400713915212E-01, 0.4060142980038694E-01, &
