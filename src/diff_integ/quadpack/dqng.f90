...
SUBROUTINE DQNG(F,A,B,Epsabs,Epsrel,Result,Abserr,Neval,Ier)
  ...
  !
  REAL(8), PARAMETER :: x1(5) = [ 0.973906528517171720077964012084452D0, &
  ...
  REAL(8), PARAMETER :: w10(5) = [ 0.066671344308688137593568809893332D0, &
  ...
  REAL(8), PARAMETER :: x2(5) = [ 0.995657163025808080735527280689003D0, &
  ...
  REAL(8), PARAMETER :: w21a(5) = [ 0.032558162307964727478818972459390D0, &
  ...
  REAL(8), PARAMETER :: w21b(6) = [ 0.011694638867371874278064396062192D0, &
  ...
  REAL(8), PARAMETER :: x3(11) = [ 0.999333360901932081394099323919911D0, &
  ...
  REAL(8), PARAMETER :: w43a(10) = [ 0.016296734289666564924281974617663D0, &
  ...
  REAL(8), PARAMETER :: w43b(12) = [ 0.001844477640212414100389106552965D0, &
  ...
  REAL(8), PARAMETER :: x4(22) = [ 0.999902977262729234490529830591582D0, &
  ...
  REAL(8), PARAMETER :: w87a(21) = [ 0.008148377384149172900002878448190D0, &
  ...
  REAL(8), PARAMETER :: w87b(23) = [ 0.000274145563762072350016527092881D0, &
