...
SUBROUTINE QK51(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  !
  REAL A, absc, Abserr, B, centr, dhlgth, epmach, fc, fsum, fval1, fval2, fv1(25), &
    fv2(25), hlgth, Resabs, Resasc, resg, resk, reskh, Result, uflow
  INTEGER j, jtw, jtwm1
  REAL, EXTERNAL :: F
  !
  ...
  !
  REAL, PARAMETER :: xgk(26) = [ 0.9992621049926098E+00, 0.9955569697904981E+00, &
  ...
  REAL, PARAMETER :: wgk(26) = [ 0.1987383892330316E-02, 0.5561932135356714E-02, &
  ...
  REAL, PARAMETER :: wg(13) = [ 0.1139379850102629E-01, 0.2635498661503214E-01, &
