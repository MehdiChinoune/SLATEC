...
SUBROUTINE DQK41(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(DP), PARAMETER :: wg(10) = [ 0.017614007139152118311861962351853D0, &
  ...
  REAL(DP), PARAMETER :: xgk(21) = [ 0.998859031588277663838315576545863D0, &
  ...
  REAL(DP), PARAMETER :: wgk(21) = [ 0.003073583718520531501218293246031D0, &
