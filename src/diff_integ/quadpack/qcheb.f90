!** QCHEB
PURE SUBROUTINE QCHEB(X,Fval,Cheb12,Cheb24)
  ...
  !
  REAL(SP), INTENT(IN) :: X(11)
  REAL(SP), INTENT(INOUT) :: Fval(25)
  REAL(SP), INTENT(OUT) :: Cheb12(13), Cheb24(25)
  !
  INTEGER :: i, j
  REAL(SP) :: alam, alam1, alam2, part1, part2, part3, v(12)
  !
  ...
  END DO
  Cheb24(1) = 0.5_SP*alam*Cheb24(1)
  Cheb24(25) = 0.5_SP*alam*Cheb24(25)
  !
