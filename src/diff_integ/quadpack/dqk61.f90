...
SUBROUTINE DQK61(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(DP), PARAMETER :: wg(15) = [ 0.007968192496166605615465883474674D0, &
  ...
  REAL(DP), PARAMETER :: xgk(31) = [ 0.999484410050490637571325895705811D0, &
  ...
  REAL(DP), PARAMETER :: wgk(31) = [ 0.001389013698677007624551591226760D0, &
