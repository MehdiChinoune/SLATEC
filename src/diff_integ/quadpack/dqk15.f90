...
SUBROUTINE DQK15(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(DP), PARAMETER :: wg(4) = [ 0.129484966168869693270611432679082D0, &
    0.279705391489276667901467771423780D0, 0.381830050505118944950369775488975D0, &
    0.417959183673469387755102040816327D0 ]
  REAL(DP), PARAMETER :: xgk(8) = [ 0.991455371120812639206854697526329D0, &
  ...
  REAL(DP), PARAMETER :: wgk(8) = [ 0.022935322010529224963732008058970D0, &
