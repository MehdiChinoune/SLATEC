...
SUBROUTINE QNG(F,A,B,Epsabs,Epsrel,Result,Abserr,Neval,Ier)
  ...
  !                   ABSCISSAE X4
  !
  REAL, PARAMETER :: x1(5) = [ 0.9739065285171717E+00, 0.8650633666889845E+00, &
    0.6794095682990244E+00, 0.4333953941292472E+00, 0.1488743389816312E+00 ]
  REAL, PARAMETER :: x2(5) = [ 0.9956571630258081E+00, 0.9301574913557082E+00, &
    0.7808177265864169E+00, 0.5627571346686047E+00, 0.2943928627014602E+00 ]
  REAL, PARAMETER :: x3(11) = [ 0.9993333609019321E+00, 0.9874334029080889E+00, &
  ...
  REAL, PARAMETER :: x4(22) = [ 0.9999029772627292E+00, 0.9979898959866787E+00, &
  ...
  REAL, PARAMETER :: w10(5) = [ 0.6667134430868814E-01, 0.1494513491505806E+00, &
    0.2190863625159820E+00, 0.2692667193099964E+00, 0.2955242247147529E+00 ]
  REAL, PARAMETER :: w21a(5) = [ 0.3255816230796473E-01, 0.7503967481091995E-01, &
    0.1093871588022976E+00, 0.1347092173114733E+00, 0.1477391049013385E+00 ]
  REAL, PARAMETER :: w21b(6) = [ 0.1169463886737187E-01, 0.5475589657435200E-01, &
    0.9312545458369761E-01, 0.1234919762620659E+00, 0.1427759385770601E+00, &
    0.1494455540029169E+00 ]
  REAL, PARAMETER :: w43a(10) = [ 0.1629673428966656E-01, 0.3752287612086950E-01, &
  ...
  REAL, PARAMETER :: w43b(12) = [ 0.1844477640212414E-02, 0.1079868958589165E-01, &
  ...
  REAL, PARAMETER :: w87a(21) = [ 0.8148377384149173E-02, 0.1876143820156282E-01, &
  ...
  REAL, PARAMETER :: w87b(23) = [ 0.2741455637620724E-03, 0.1807124155057943E-02, &
