...
SUBROUTINE QK21(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  !
  REAL(SP), PARAMETER :: xgk(11) = [ 0.9956571630258081E+00, 0.9739065285171717E+00, &
  ...
  REAL(SP), PARAMETER :: wgk(11) = [ 0.1169463886737187E-01, 0.3255816230796473E-01, &
  ...
  REAL(SP), PARAMETER :: wg(5) = [ 0.6667134430868814E-01, 0.1494513491505806E+00, &
