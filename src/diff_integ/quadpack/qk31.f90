...
SUBROUTINE QK31(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  !
  REAL(SP), PARAMETER :: xgk(16) = [ 0.9980022986933971E+00, 0.9879925180204854E+00, &
  ...
  REAL(SP), PARAMETER :: wgk(16) = [ 0.5377479872923349E-02, 0.1500794732931612E-01, &
  ...
  REAL(SP), PARAMETER :: wg(8) = [ 0.3075324199611727E-01, 0.7036604748810812E-01, &
