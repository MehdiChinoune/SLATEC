...
SUBROUTINE DQK21(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  REAL(8) :: A, absc, Abserr, B, centr, dhlgth, epmach, fc, fsum, fval1, fval2, &
    fv1(10), fv2(10), hlgth, Resabs, Resasc, resg, resk, reskh, Result, uflow
  INTEGER j, jtw, jtwm1
  REAL(8), EXTERNAL :: F
  !
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(8), PARAMETER :: wg(5) = [ 0.066671344308688137593568809893332D0, &
  ...
  REAL(8), PARAMETER :: xgk(11) = [ 0.995657163025808080735527280689003D0, &
  ...
  REAL(8), PARAMETER :: wgk(11) = [ 0.011694638867371874278064396062192D0, &
