...
SUBROUTINE DQK51(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  INTEGER :: j, jtw, jtwm1
  REAL(8) :: absc, centr, dhlgth, epmach, fc, fsum, fval1, fval2, fv1(25), &
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(8), PARAMETER :: wg(13) = [ 0.011393798501026287947902964113235D0, &
  ...
  REAL(8), PARAMETER :: xgk(26) = [ 0.999262104992609834193457486540341D0, &
  ...
  REAL(8), PARAMETER :: wgk(26) = [ 0.001987383892330315926507851882843D0, &
