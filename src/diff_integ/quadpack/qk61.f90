...
SUBROUTINE QK61(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  !
  REAL(SP), PARAMETER :: xgk(31) = [ 0.9994844100504906E+00, 0.9968934840746495E+00, &
  ...
  REAL(SP), PARAMETER :: wgk(31) = [ 0.1389013698677008E-02, 0.3890461127099884E-02, &
  ...
  REAL(SP), PARAMETER :: wg(15) = [ 0.7968192496166606E-02, 0.1846646831109096E-01, &
