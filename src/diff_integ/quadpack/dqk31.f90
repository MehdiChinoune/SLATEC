...
SUBROUTINE DQK31(F,A,B,Result,Abserr,Resabs,Resasc)
  ...
  INTEGER :: j, jtw, jtwm1
  REAL(8) :: absc, centr, dhlgth, epmach, fc, fsum, fval1, fval2, fv1(15), &
  ...
  ! BELL LABS, NOV. 1981.
  !
  REAL(8), PARAMETER :: wg(8) = [ 0.030753241996117268354628393577204D0, &
  ...
  REAL(8), PARAMETER :: xgk(16) = [ 0.998002298693397060285172840152271D0, &
  ...
  REAL(8), PARAMETER :: wgk(16) = [ 0.005377479872923348987792051430128D0, &
