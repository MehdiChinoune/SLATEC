MODULE DML
  ...
  INTEGER :: igofx_com, inhomo_com, ivp_com, ncomp_com, nfc_com, info_com(15), &
    ...
    lpar_com, kkkzpw_com, needw_com, neediw_com, k1_com, k2_com, k3_com, k4_com, &
    k5_com, k6_com, k7_com, k8_com, k9_com, k10_com, k11_com, l1_com, l2_com, &
    kkkint_com, lllint_com, nofst_com
END MODULE DML