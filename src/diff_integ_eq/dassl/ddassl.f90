...
SUBROUTINE DDASSL(RES,Neq,T,Y,Yprime,Tout,Info,Rtol,Atol,Idid,Rwork,Lrw,&
  ...
  IF ( Info(1)==0 ) THEN
    ...
    IF ( Neq<=0 ) THEN
      !
      WRITE (xern1,'(I8)') Neq
      CALL XERMSG('DDASSL','NEQ = '//xern1//' .LE. 0',2,1)
      GOTO 1200
    ELSE
      !
      ...
      ELSE
        ...
        IF ( Info(7)/=0 ) THEN
          ...
          IF ( hmax<=0.0D0 ) THEN
            ...
            CALL XERMSG('DDASSL','HMAX = '//xern3//' .LT. 0.0',10,1)
            GOTO 1200
          END IF
        END IF
        !
    ...
    IF ( Info(1)==1 ) THEN
      ...
      IF ( Info(4)==1 ) THEN
        IF ( Info(3)==1 ) THEN
          ...
          IF ( (tstop-Tout)*h<0.0D0 ) GOTO 700
  ...
  GOTO 1200
  !
  500  CALL XERMSG('DDASSL','SOME ELEMENT OF RTOL IS .LT. 0',6,1)
  GOTO 1200
  !
  600  CALL XERMSG('DDASSL','SOME ELEMENT OF ATOL IS .LT. 0',7,1)
  GOTO 1200
  !
  ...
  GOTO 1200
  !
  900  CALL XERMSG('DDASSL','SOME ELEMENT OF WT IS .LE. 0.0',13,1)
  GOTO 1200
  !
