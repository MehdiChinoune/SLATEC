!** SSLUOM
PURE SUBROUTINE SSLUOM(N,B,X,Nelt,Ia,Ja,A,Isym,Nsave,Itol,Tol,Itmax,Iter,Err,&
  ...
  ! **Category:**  D2A4, D2B4
  !***
  ! **Type:**      SINGLE PRECISION (SSLUOM-S, DSLUOM-D)
  !***
  ...
  !     REAL RWORK(NL+NU+7*N+3*N*NSAVE+NSAVE)
  !
  ...
  !
  !***
  ! **See also:**  SOMN, SSDOMN
  !***
  ! **References:**  (NONE)
  !***
  ! **Routines called:**  SCHKW, SOMN, SS2Y, SSILUS, SSLUI, SSMV
