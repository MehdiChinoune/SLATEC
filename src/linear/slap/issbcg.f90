!** ISSBCG
INTEGER PURE FUNCTION ISSBCG(N,Itol,Tol,R,Z,Dz,Bnrm,Solnrm)
  !> Preconditioned BiConjugate Gradient Stop Test.
  !  This routine calculates the stop test for the BiConjugate Gradient iteration scheme.
