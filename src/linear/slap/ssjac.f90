!** SSJAC
PURE SUBROUTINE SSJAC(N,B,X,Nelt,Ia,Ja,A,Isym,Itol,Tol,Itmax,Iter,Err,Ierr,&
  ...
  ! **Category:**  D2A4, D2B4
  !***
  ! **Type:**      SINGLE PRECISION (SSJAC-S, DSJAC-D)
  !***
  ...
  ! **References:**  (NONE)
  !***
  ! **Routines called:**  SCHKW, SIR, SS2Y, SSDI, SSDS, SSMV
  ...
  CALL SIR(N,B,X,Nelt,Ia,Ja,A,Isym,SSMV,SSDI,Itol,Tol,Itmax,Iter,Ierr,&
    Rwork(locr),Rwork(locz),Rwork(locdz),Rwork,Iwork)
  !------------- LAST LINE OF SSJAC FOLLOWS -----------------------------
END SUBROUTINE SSJAC