!** SSMMI2
PURE SUBROUTINE SSMMI2(N,B,X,Il,Jl,L,Dinv,Iu,Ju,U)
  !> SLAP Backsolve for LDU Factorization of Normal Equations.
  !  To solve a system of the form  (L*D*U)*(L*D*U)' X = B, where L is a unit
  ...
  ! **Category:**  D2E
  !***
  ! **Type:**      SINGLE PRECISION (SSMMI2-S, DSMMI2-D)
  !***
  ...
  !
  !     CALL SSMMI2( N, B, X, IL, JL, L, DINV, IU, JU, U )
  !
  !- Arguments:
  ! N      :IN       Integer
  !         Order of the Matrix.
