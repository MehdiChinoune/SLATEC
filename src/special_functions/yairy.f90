...
SUBROUTINE YAIRY(X,Rx,C,Bi,Dbi)
  ...
  REAL(SP), PARAMETER :: fpi12 = 1.30899693899575E+00, spi12 = 1.83259571459405E+00, &
    con1 = 6.66666666666667E-01, con2 = 7.74148278841779E+00, &
    con3 = 3.64766105490356E-01
  REAL(SP), PARAMETER :: bk1(20) = [ 2.43202846447449E+00, 2.57132009754685E+00, &
  ...
  REAL(SP), PARAMETER :: bk2(20) = [ 5.74830555784088E-01, -6.91648648376891E-03, &
  ...
  REAL(SP), PARAMETER :: bk3(20) = [ 5.66777053506912E-01, 2.63672828349579E-03, &
  ...
  REAL(SP), PARAMETER :: bk4(14) = [ 4.85444386705114E-01, -3.08525088408463E-03, &
  ...
  REAL(SP), PARAMETER :: bjp(19) = [ 1.34918611457638E-01, -3.19314588205813E-01, &
  ...
  REAL(SP), PARAMETER :: bjn(19) = [ 6.59041673525697E-02, -4.24905910566004E-01, &
  ...
  REAL(SP), PARAMETER :: aa(14) = [ -2.78593552803079E-01, 3.52915691882584E-03, &
  ...
  REAL(SP), PARAMETER :: bb(14) = [ -4.90275424742791E-01, -1.57647277946204E-03, &
  ...
  REAL(SP), PARAMETER :: dbk1(21) = [ 2.95926143981893E+00, 3.86774568440103E+00, &
  ...
  REAL(SP), PARAMETER :: dbk2(20) = [ 5.49756809432471E-01, 9.13556983276901E-03, &
  ...
  REAL(SP), PARAMETER :: dbk3(20) = [ 5.60598509354302E-01, -3.64870013248135E-03, &
  ...
  REAL(SP), PARAMETER :: dbk4(14) = [ 4.93072999188036E-01, 4.38335419803815E-03, &
  ...
  REAL(SP), PARAMETER :: dbjp(19) = [ 1.13140872390745E-01, -2.08301511416328E-01, &
  ...
  REAL(SP), PARAMETER :: dbjn(19) = [ -1.88091260068850E-02, -1.47798180826140E-01, &
  ...
  REAL(SP), PARAMETER :: daa(14) = [ 2.77571356944231E-01, -4.44212833419920E-03, &
  ...
  REAL(SP), PARAMETER :: dbb(14) = [ 4.91627321104601E-01, 3.11164930427489E-03, &
