...
SUBROUTINE JAIRY(X,Rx,C,Ai,Dai)
  ...
  REAL, PARAMETER :: ak2(23) = [ 2.74366150869598E-01, 5.39790969736903E-03, &
  ...
  REAL, PARAMETER :: ak3(14) = [ 2.80271447340791E-01, -1.78127042844379E-03, &
  ...
  REAL, PARAMETER :: ajp(19) = [ 7.78952966437581E-02, -1.84356363456801E-01, &
  ...
  REAL, PARAMETER :: ajn(19) = [ 3.80497887617242E-02, -2.45319541845546E-01, &
  ...
  REAL, PARAMETER :: a(15) = [ 4.90275424742791E-01, 1.57647277946204E-03, &
  ...
  REAL, PARAMETER :: b(15) = [ 2.78593552803079E-01, -3.52915691882584E-03, &
  ...
  REAL, PARAMETER :: dak2(24) = [ 2.93332343883230E-01, -8.06196784743112E-03, &
  ...
  REAL, PARAMETER :: dak3(14) = [ 2.84675828811349E-01, 2.53073072619080E-03, &
  ...
  REAL, PARAMETER :: dajp(19) = [ 6.53219131311457E-02, -1.20262933688823E-01, &
  ...
  REAL, PARAMETER :: dajn(19) = [ 1.08594539632967E-02, 8.53313194857091E-02, &
  ...
  REAL, PARAMETER :: da(15) = [ 4.91627321104601E-01, 3.11164930427489E-03, &
  ...
  REAL, PARAMETER :: db(15) = [ -2.77571356944231E-01, 4.44212833419920E-03, &
