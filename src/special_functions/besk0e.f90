...
REAL(SP) FUNCTION BESK0E(X)
  ...
  REAL(SP), PARAMETER :: xsml = SQRT(4.0*R1MACH(3))
  ...
  REAL(SP), PARAMETER :: ak0cs(17) = [ -.07643947903327941E0, -.02235652605699819E0, &
  ...
  REAL(SP), PARAMETER :: ak02cs(14) = [ -.01201869826307592E0,-.00917485269102569E0, &
