...
SUBROUTINE ASYJY(FUNJY,X,Fnu,Flgjy,In,Y,Wk,Iflw)
  ...
  REAL(SP), PARAMETER :: tols = -6.90775527898214E+00
  REAL(SP), PARAMETER :: con1 = 6.66666666666667E-01, con2 = 3.33333333333333E-01, &
    con548 = 1.04166666666667E-01
  REAL(SP), PARAMETER :: ar(8) = [ 8.35503472222222E-02, 1.28226574556327E-01, &
  ...
  REAL(SP), PARAMETER :: br(10) = [ -1.45833333333333E-01, -9.87413194444444E-02, &
  ...
  REAL(SP), PARAMETER :: c(65) = [ -2.08333333333333E-01, 1.25000000000000E-01, &
  ...
  REAL(SP), PARAMETER :: alfa1(26,2) = RESHAPE( [ -4.44444444444444E-03, &
    ...
    -2.05352753106481E-05, -1.84816217627666E-05, -1.66519330021394E-05 ], [26,2] )
  REAL(SP), PARAMETER :: alfa2(26,2) = RESHAPE( [ -3.54211971457744E-04, &
    -1.56161263945159E-04, 3.04465503594936E-05, 1.30198655773243E-04, &
    1.67471106699712E-04, 1.70222587683593E-04, 1.56501427608595E-04, &
    1.36339170977445E-04, 1.14886692029825E-04, 9.45869093034688E-05, &
    7.64498419250898E-05, 6.07570334965197E-05, 4.74394299290509E-05, &
    3.62757512005344E-05, 2.69939714979225E-05, 1.93210938247939E-05, &
    1.30056674793963E-05, 7.82620866744497E-06, 3.59257485819352E-06, &
    1.44040049814252E-07, -2.65396769697939E-06, -4.91346867098486E-06, &
    -6.72739296091248E-06, -8.17269379678658E-06, -9.31304715093561E-06, &
    -1.02011418798016E-05, 3.78194199201773E-04, 2.02471952761816E-04, &
    ...
    5.89199657344698E-05, 5.72515823777593E-05, 5.52804375585853E-05 ], [26,2] )
  REAL(SP), PARAMETER :: beta1(26,2) = RESHAPE( [ 1.79988721413553E-02, &
    5.59964911064388E-03, 2.88501402231133E-03, 1.80096606761054E-03, &
    1.24753110589199E-03, 9.22878876572938E-04, 7.14430421727287E-04, &
    5.71787281789705E-04, 4.69431007606482E-04, 3.93232835462917E-04, &
    3.34818889318298E-04, 2.88952148495752E-04, 2.52211615549573E-04, &
    2.22280580798883E-04, 1.97541838033063E-04, 1.76836855019718E-04, &
    1.59316899661821E-04, 1.44347930197334E-04, 1.31448068119965E-04, &
    1.20245444949303E-04, 1.10449144504599E-04, 1.01828770740567E-04, &
    9.41998224204238E-05, 8.74130545753834E-05, 8.13466262162801E-05, &
    7.59002269646219E-05, -1.49282953213429E-03, -8.78204709546389E-04, &
    ...
    2.11507649256221E-05, 2.06388749782171E-05, 2.01165241997082E-05 ], [26,2] )
  REAL(SP), PARAMETER :: beta2(26,2) = RESHAPE( [ 5.52213076721293E-04, &
    4.47932581552385E-04, 2.79520653992021E-04, 1.52468156198447E-04, &
    6.93271105657044E-05, 1.76258683069991E-05, -1.35744996343269E-05, &
    -3.17972413350427E-05, -4.18861861696693E-05, -4.69004889379141E-05, &
    -4.87665447413787E-05, -4.87010031186735E-05, -4.74755620890087E-05, &
    -4.55813058138628E-05, -4.33309644511266E-05, -4.09230193157750E-05, &
    -3.84822638603221E-05, -3.60857167535411E-05, -3.37793306123367E-05, &
    -3.15888560772110E-05, -2.95269561750807E-05, -2.75978914828336E-05, &
    -2.58006174666884E-05, -2.41308356761280E-05, -2.25823509518346E-05, &
    -2.11479656768913E-05, -4.74617796559960E-04, -4.77864567147321E-04, &
    ...
    2.29363633690998E-05, 1.97893056664022E-05, 1.70091984636413E-05 ], [26,2] )
  REAL(SP), PARAMETER :: beta3(26,1) = RESHAPE( [ 7.36465810572578E-04, &
    8.72790805146194E-04, 6.22614862573135E-04, 2.85998154194304E-04, &
    3.84737672879366E-06, -1.87906003636972E-04, -2.97603646594555E-04, &
    -3.45998126832656E-04, -3.53382470916038E-04, -3.35715635775049E-04, &
    -3.04321124789040E-04, -2.66722723047613E-04, -2.27654214122820E-04, &
    -1.89922611854562E-04, -1.55058918599094E-04, -1.23778240761874E-04, &
    -9.62926147717644E-05, -7.25178327714425E-05, -5.22070028895634E-05, &
    -3.50347750511901E-05, -2.06489761035552E-05, -8.70106096849767E-06, &
    1.13698686675100E-06, 9.16426474122779E-06, 1.56477785428873E-05, &
    2.08223629482467E-05 ], [26,1] )
  REAL(SP), PARAMETER :: alfa(26,4) = RESHAPE( [ alfa1, alfa2 ], [26,4] )
  REAL(SP), PARAMETER :: beta(26,5) = RESHAPE( [ beta1, beta2, beta3 ], [26,5] )
  REAL(SP), PARAMETER :: gama(26) = [ 6.29960524947437E-01, 2.51984209978975E-01, &
