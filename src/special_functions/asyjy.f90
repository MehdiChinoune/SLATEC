...
SUBROUTINE ASYJY(FUNJY,X,Fnu,Flgjy,In,Y,Wk,Iflw)
  ...
  REAL, PARAMETER :: br(10) = [ -1.45833333333333E-01, -9.87413194444444E-02, &
  ...
  REAL, PARAMETER :: alfa1(26,2) = RESHAPE( [ -4.44444444444444E-03, &
  ...
  REAL, PARAMETER :: alfa2(26,2) = RESHAPE( [ -3.54211971457744E-04, &
  ...
  REAL, PARAMETER :: beta1(26,2) = RESHAPE( [ 1.79988721413553E-02, &
  ...
  REAL, PARAMETER :: beta2(26,2) = RESHAPE( [ 5.52213076721293E-04, &
  ...
  REAL, PARAMETER :: beta3(26,1) = RESHAPE( [ 7.36465810572578E-04, &
  ...
  REAL, PARAMETER :: alfa(26,4) = RESHAPE( [ alfa1, alfa2 ], [26,4] )
  REAL, PARAMETER :: beta(26,5) = RESHAPE( [ beta1, beta2, beta3 ], [26,5] )
  REAL, PARAMETER :: gama(26) = [ 6.29960524947437E-01, 2.51984209978975E-01, &
