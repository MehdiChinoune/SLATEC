...
SUBROUTINE R9AIMP(X,Ampl,Theta)
  ...
  REAL(SP), PARAMETER :: eta = 0.1*R1MACH(3), xsml = -1.0/R1MACH(3)**0.3333
  REAL(SP), PARAMETER :: am21cs(40) = [ .0065809191761485E0, .0023675984685722E0, &
  ...
  REAL(SP), PARAMETER :: ath1cs(36) = [ -.07125837815669365E0, -.00590471979831451E0, &
    ...
    -.00000000000000002E0 ]
  REAL(SP), PARAMETER :: am22cs(33) = [ -.01562844480625341E0, .00778336445239681E0, &
    ...
    .00000000000000002E0 ]
  REAL(SP), PARAMETER :: ath2cs(32) = [ .00440527345871877E0,-.03042919452318455E0, &
