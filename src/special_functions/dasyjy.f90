...
SUBROUTINE DASYJY(FUNJY,X,Fnu,Flgjy,In,Y,Wk,Iflw)
  ...
  REAL(DP), PARAMETER :: tols = -6.90775527898214D+00
  REAL(DP), PARAMETER :: con1 = 6.66666666666667D-01, con2 = 3.33333333333333D-01, &
    con548 = 1.04166666666667D-01
  REAL(DP), PARAMETER :: ar(8) = [ 8.35503472222222D-02, 1.28226574556327D-01, &
  ...
  REAL(DP), PARAMETER :: br(10) = [ -1.45833333333333D-01, -9.87413194444444D-02, &
  ...
  REAL(DP), PARAMETER :: c(65) = [ -2.08333333333333D-01, 1.25000000000000D-01, &
    3.34201388888889D-01, -4.01041666666667D-01, 7.03125000000000D-02, &
    -1.02581259645062D+00, 1.84646267361111D+00, -8.91210937500000D-01, &
    7.32421875000000D-02, 4.66958442342625D+00, -1.12070026162230D+01, &
    8.78912353515625D+00, -2.36408691406250D+00, 1.12152099609375D-01, &
    -2.82120725582002D+01, 8.46362176746007D+01, -9.18182415432400D+01, &
    4.25349987453885D+01, -7.36879435947963D+00, 2.27108001708984D-01, &
    2.12570130039217D+02, -7.65252468141182D+02, 1.05999045252800D+03, &
    -6.99579627376133D+02, 2.18190511744212D+02, -2.64914304869516D+01, &
    5.72501420974731D-01, -1.91945766231841D+03, 8.06172218173731D+03, &
    -1.35865500064341D+04, 1.16553933368645D+04, -5.30564697861340D+03, &
    1.20090291321635D+03, -1.08090919788395D+02, 1.72772750258446D+00, &
    2.02042913309661D+04, -9.69805983886375D+04, 1.92547001232532D+05, &
    -2.03400177280416D+05, 1.22200464983017D+05, -4.11926549688976D+04, &
    7.10951430248936D+03, -4.93915304773088D+02, 6.07404200127348D+00, &
    -2.42919187900551D+05, 1.31176361466298D+06, -2.99801591853811D+06, &
    3.76327129765640D+06, -2.81356322658653D+06, 1.26836527332162D+06, &
    -3.31645172484564D+05, 4.52187689813627D+04, -2.49983048181121D+03, &
    2.43805296995561D+01, 3.28446985307204D+06, -1.97068191184322D+07, &
    5.09526024926646D+07, -7.41051482115327D+07, 6.63445122747290D+07, &
    -3.75671766607634D+07, 1.32887671664218D+07, -2.78561812808645D+06, &
    3.08186404612662D+05, -1.38860897537170D+04, 1.10017140269247D+02 ]
  REAL(DP), PARAMETER :: alfa1(26,2) = RESHAPE( [ -4.44444444444444D-03, &
    -9.22077922077922D-04, -8.84892884892885D-05, 1.65927687832450D-04, &
    2.46691372741793D-04, 2.65995589346255D-04, 2.61824297061501D-04, &
    2.48730437344656D-04, 2.32721040083232D-04, 2.16362485712365D-04, &
    2.00738858762752D-04, 1.86267636637545D-04, 1.73060775917876D-04, &
    1.61091705929016D-04, 1.50274774160908D-04, 1.40503497391270D-04, &
    1.31668816545923D-04, 1.23667445598253D-04, 1.16405271474738D-04, &
    1.09798298372713D-04, 1.03772410422993D-04, 9.82626078369363D-05, &
    9.32120517249503D-05, 8.85710852478712D-05, 8.42963105715700D-05, &
    8.03497548407791D-05, 6.93735541354589D-04, 2.32241745182922D-04, &
    ...
    -2.05352753106481D-05, -1.84816217627666D-05, -1.66519330021394D-05 ], [26,2] )
  REAL(DP), PARAMETER :: alfa2(26,2) = RESHAPE( [ -3.54211971457744D-04, &
    -1.56161263945159D-04, 3.04465503594936D-05, 1.30198655773243D-04, &
    1.67471106699712D-04, 1.70222587683593D-04, 1.56501427608595D-04, &
    1.36339170977445D-04, 1.14886692029825D-04, 9.45869093034688D-05, &
    7.64498419250898D-05, 6.07570334965197D-05, 4.74394299290509D-05, &
    3.62757512005344D-05, 2.69939714979225D-05, 1.93210938247939D-05, &
    1.30056674793963D-05, 7.82620866744497D-06, 3.59257485819352D-06, &
    1.44040049814252D-07, -2.65396769697939D-06, -4.91346867098486D-06, &
    -6.72739296091248D-06, -8.17269379678658D-06, -9.31304715093561D-06, &
    -1.02011418798016D-05, 3.78194199201773D-04, 2.02471952761816D-04, &
    ...
    5.89199657344698D-05, 5.72515823777593D-05, 5.52804375585853D-05 ], [26,2] )
  REAL(DP), PARAMETER :: beta1(26,2) = RESHAPE( [ 1.79988721413553D-02, &
    5.59964911064388D-03, 2.88501402231133D-03, 1.80096606761054D-03, &
    1.24753110589199D-03, 9.22878876572938D-04, 7.14430421727287D-04, &
    5.71787281789705D-04, 4.69431007606482D-04, 3.93232835462917D-04, &
    3.34818889318298D-04, 2.88952148495752D-04, 2.52211615549573D-04, &
    2.22280580798883D-04, 1.97541838033063D-04, 1.76836855019718D-04, &
    1.59316899661821D-04, 1.44347930197334D-04, 1.31448068119965D-04, &
    1.20245444949303D-04, 1.10449144504599D-04, 1.01828770740567D-04, &
    9.41998224204238D-05, 8.74130545753834D-05, 8.13466262162801D-05, &
    7.59002269646219D-05, -1.49282953213429D-03, -8.78204709546389D-04, &
    ...
    2.11507649256221D-05, 2.06388749782171D-05, 2.01165241997082D-05 ], [26,2] )
  REAL(DP), PARAMETER :: beta2(26,2) = RESHAPE( [ 5.52213076721293D-04, &
    4.47932581552385D-04, 2.79520653992021D-04, 1.52468156198447D-04, &
    6.93271105657044D-05, 1.76258683069991D-05, -1.35744996343269D-05, &
    -3.17972413350427D-05, -4.18861861696693D-05, -4.69004889379141D-05, &
    -4.87665447413787D-05, -4.87010031186735D-05, -4.74755620890087D-05, &
    -4.55813058138628D-05, -4.33309644511266D-05, -4.09230193157750D-05, &
    -3.84822638603221D-05, -3.60857167535411D-05, -3.37793306123367D-05, &
    -3.15888560772110D-05, -2.95269561750807D-05, -2.75978914828336D-05, &
    -2.58006174666884D-05, -2.41308356761280D-05, -2.25823509518346D-05, &
    -2.11479656768913D-05, -4.74617796559960D-04, -4.77864567147321D-04, &
    ...
    2.29363633690998D-05, 1.97893056664022D-05, 1.70091984636413D-05 ], [26,2] )
  REAL(DP), PARAMETER :: beta3(26,1) = RESHAPE( [ 7.36465810572578D-04, &
    8.72790805146194D-04, 6.22614862573135D-04, 2.85998154194304D-04, &
    3.84737672879366D-06, -1.87906003636972D-04, -2.97603646594555D-04, &
    -3.45998126832656D-04, -3.53382470916038D-04, -3.35715635775049D-04, &
    -3.04321124789040D-04, -2.66722723047613D-04, -2.27654214122820D-04, &
    -1.89922611854562D-04, -1.55058918599094D-04, -1.23778240761874D-04, &
    -9.62926147717644D-05, -7.25178327714425D-05, -5.22070028895634D-05, &
    -3.50347750511901D-05, -2.06489761035552D-05, -8.70106096849767D-06, &
    1.13698686675100D-06, 9.16426474122779D-06, 1.56477785428873D-05, &
    2.08223629482467D-05 ], [26,1] )
  REAL(DP), PARAMETER :: alfa(26,4) = RESHAPE( [ alfa1, alfa2 ], [26,4] )
  REAL(DP), PARAMETER :: beta(26,5) = RESHAPE( [ beta1, beta2, beta3 ], [26,5] )
  REAL(DP), PARAMETER :: gama(26) = [ 6.29960524947437D-01, 2.51984209978975D-01, &
