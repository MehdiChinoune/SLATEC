...
SUBROUTINE DASYJY(FUNJY,X,Fnu,Flgjy,In,Y,Wk,Iflw)
  ...
  INTEGER I1MACH
  REAL(8) :: abw2, akm, ap, asum, az, bsum, con1, &
    con2, con548, cr(10), crz32, dfi, elim, dr(10), fi, &
    Flgjy, fn, Fnu, fn2, phi, rcz, rden, relb, &
    rfn2, rtz, rzden, sa, sb, suma, sumb, s1, ta, &
    tau, tb, tfn, tol, tols, t2, upol(10), Wk(*), X, xx, Y(*), z, z32
  REAL(8) :: D1MACH
  ...
  REAL(8), PARAMETER :: ar(8) = [ 8.35503472222222D-02, 1.28226574556327D-01, &
  ...
  REAL(8), PARAMETER :: br(10) = [ -1.45833333333333D-01, -9.87413194444444D-02, &
  ...
  REAL(8), PARAMETER :: alfa1(26,2) = RESHAPE( [ -4.44444444444444D-03, &
  ...
  REAL(8), PARAMETER :: alfa2(26,2) = RESHAPE( [ -3.54211971457744D-04, &
  ...
  REAL(8), PARAMETER :: beta1(26,2) = RESHAPE( [ 1.79988721413553D-02, &
  ...
  REAL(8), PARAMETER :: beta2(26,2) = RESHAPE( [ 5.52213076721293D-04, &
  ...
  REAL(8), PARAMETER :: beta3(26,1) = RESHAPE( [ 7.36465810572578D-04, &
  ...
  REAL(8), PARAMETER :: alfa(26,4) = RESHAPE( [ alfa1, alfa2 ], [26,4] )
  REAL(8), PARAMETER :: beta(26,5) = RESHAPE( [ beta1, beta2, beta3 ], [26,5] )
  REAL(8), PARAMETER :: gama(26) = [ 6.29960524947437D-01, 2.51984209978975D-01, &
