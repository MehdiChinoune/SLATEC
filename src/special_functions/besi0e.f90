...
REAL(SP) FUNCTION BESI0E(X)
  ...
  REAL(SP), PARAMETER :: xsml = SQRT(4.5*R1MACH(3))
  REAL(SP), PARAMETER :: bi0cs(12) = [ -.07660547252839144951E0, 1.927337953993808270E0, &
  ...
  REAL(SP), PARAMETER :: ai0cs(21) = [ .07575994494023796E0, .00759138081082334E0, &
    ...
    .00000000000000007E0 ]
  REAL(SP), PARAMETER :: ai02cs(22) = [ .05449041101410882E0, .00336911647825569E0, &
