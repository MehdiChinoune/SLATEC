!** ZUNIK
PURE SUBROUTINE ZUNIK(Zr,Fnu,Ikflg,Ipmtr,Tol,Init,Phi,Zeta1,Zeta2,Summ,Cwrk)
  ...
  COMPLEX(DP), INTENT(INOUT) :: Phi, Summ, Zeta1, Zeta2, Cwrk(16)
  !
  INTEGER :: i, j, k, l
  REAL(DP) :: ac, rfn, test, tstr, tsti
  COMPLEX(DP) :: cfn, crfn, s, sr, t, t2, zn
  COMPLEX(DP), PARAMETER :: con(2) = [ (3.98942280401432678E-01_DP,0._DP), &
    (1.25331413731550025E+00_DP,0._DP) ]
