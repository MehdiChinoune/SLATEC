...
REAL(SP) FUNCTION BESI1E(X)
  ...
  REAL(SP), PARAMETER :: xmin = 2.0*R1MACH(1), xsml = SQRT(4.5*R1MACH(3))
  REAL(SP), PARAMETER :: bi1cs(11) = [ -.001971713261099859E0, .40734887667546481E0, &
  ...
  REAL(SP), PARAMETER :: ai1cs(21) = [ -.02846744181881479E0,-.01922953231443221E0, &
    ...
    -.00000000000000006E0 ]
  REAL(SP), PARAMETER :: ai12cs(22) = [ .02857623501828014E0,-.00976109749136147E0, &
