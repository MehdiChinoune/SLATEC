...
REAL(DP) FUNCTION DBI(X)
  ...
  REAL(DP), PARAMETER :: eta = 0.1D0*D1MACH(3), x3sml = eta**0.3333, &
    xmax = (1.5*LOG(D1MACH(2)))**0.6666D0
  REAL(DP), PARAMETER :: bifcs(13) = [ -.16730216471986649483537423928176D-1, &
  ...
  REAL(DP), PARAMETER :: bigcs(13) = [ +.22466223248574522283468220139024D-1, &
  ...
  REAL(DP), PARAMETER :: bif2cs(15) = [ +.0998457269381604104468284257993D+0, &
  ...
  REAL(DP), PARAMETER :: big2cs(15) = [ +.033305662145514340465176188111647D+0, &
