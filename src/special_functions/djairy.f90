...
SUBROUTINE DJAIRY(X,Rx,C,Ai,Dai)
  ...
  REAL(DP), PARAMETER :: fpi12 = 1.30899693899575D+00, con2 = 5.03154716196777D+00, &
    con3 = 3.80004589867293D-01, con4 = 8.33333333333333D-01, &
    con5 = 8.66025403784439D-01
  REAL(DP), PARAMETER :: ak1(14) = [ 2.20423090987793D-01, -1.25290242787700D-01, &
  ...
  REAL(DP), PARAMETER :: ak2(23) = [ 2.74366150869598D-01, 5.39790969736903D-03, &
  ...
  REAL(DP), PARAMETER :: ak3(14) = [ 2.80271447340791D-01, -1.78127042844379D-03, &
  ...
  REAL(DP), PARAMETER :: ajp(19) = [ 7.78952966437581D-02, -1.84356363456801D-01, &
  ...
  REAL(DP), PARAMETER :: ajn(19) = [ 3.80497887617242D-02, -2.45319541845546D-01, &
  ...
  REAL(DP), PARAMETER :: a(15) = [ 4.90275424742791D-01, 1.57647277946204D-03, &
  ...
  REAL(DP), PARAMETER :: b(15) = [ 2.78593552803079D-01, -3.52915691882584D-03, &
  ...
  REAL(DP), PARAMETER :: dak1(14) = [ 2.04567842307887D-01, -6.61322739905664D-02, &
  ...
  REAL(DP), PARAMETER :: dak2(24) = [ 2.93332343883230D-01, -8.06196784743112D-03, &
  ...
  REAL(DP), PARAMETER :: dak3(14) = [ 2.84675828811349D-01, 2.53073072619080D-03, &
  ...
  REAL(DP), PARAMETER :: dajp(19) = [ 6.53219131311457D-02, -1.20262933688823D-01, &
  ...
  REAL(DP), PARAMETER :: dajn(19) = [ 1.08594539632967D-02, 8.53313194857091D-02, &
  ...
  REAL(DP), PARAMETER :: da(15) = [ 4.91627321104601D-01, 3.11164930427489D-03, &
  ...
  REAL(DP), PARAMETER :: db(15) = [ -2.77571356944231D-01, 4.44212833419920D-03, &
