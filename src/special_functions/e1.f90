...
REAL(SP) FUNCTION E1(X)
  ...
  REAL(SP), PARAMETER :: eta = 0.1*R1MACH(3), xmaxt = -LOG(R1MACH(1)), &
    xmax = xmaxt - LOG(xmaxt)
  REAL(SP), PARAMETER :: ae11cs(39) = [ .12150323971606579E0, -.065088778513550150E0, &
  ...
  REAL(SP), PARAMETER :: ae12cs(25) = [ .58241749513472674E0, -.15834885090578275E0, &
  ...
  REAL(SP), PARAMETER :: e11cs(19) = [ -16.113461655571494026E0, 7.7940727787426802769E0, &
  ...
  REAL(SP), PARAMETER :: e12cs(16) =  [ -0.037390214792202795E0, 0.042723986062209577E0, &
  ...
  REAL(SP), PARAMETER :: ae13cs(25) = [ -.60577324664060346E0, -.11253524348366090E0, &
  ...
  REAL(SP), PARAMETER :: ae14cs(26) = [ -.1892918000753017E0, -.08648117855259871E0, &
