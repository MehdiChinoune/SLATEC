...
REAL(SP) FUNCTION BESK1E(X)
  ...
  REAL(SP), PARAMETER :: xmin = EXP(MAX(LOG(R1MACH(1)),-LOG(R1MACH(2)))+.01), &
    xsml = SQRT(4.0*R1MACH(3))
  REAL(SP), PARAMETER :: bk1cs(11) = [ .0253002273389477705E0,-.353155960776544876E0, &
  ...
  REAL(SP), PARAMETER :: ak1cs(17) = [ .2744313406973883E0, .07571989953199368E0, &
  ...
  REAL(SP), PARAMETER :: ak12cs(14) = [ .06379308343739001E0, .02832887813049721E0, &
