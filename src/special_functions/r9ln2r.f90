...
REAL(SP) FUNCTION R9LN2R(X)
  ...
  REAL(SP), PARAMETER :: eps = R1MACH(3), sqeps = SQRT(eps), txbig = 4.0/SQRT(sqeps), &
  ...
  REAL(SP), PARAMETER :: ln21cs(26) = [ .18111962513478810E0,-.15627123192872463E0, &
  ...
  REAL(SP), PARAMETER :: ln22cs(20) = [ -.22242532535020461E0,-.061047100108078624E0, &
