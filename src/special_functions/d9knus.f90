...
SUBROUTINE D9KNUS(Xnu,X,Bknu,Bknu1,Iswtch)
  ...
  REAL(DP), PARAMETER :: eta = 0.1D0*D1MACH(3), xnusml = SQRT(D1MACH(3)/8.D0), &
    xsml = 0.1D0*D1MACH(3), alnsml = LOG(D1MACH(1)), alnbig = LOG(D1MACH(2)), &
    alneps = LOG(0.1D0*D1MACH(3))
  REAL(DP), PARAMETER :: c0kcs(29) = [ +.60183057242626108387577445180329D-1, &
  ...
  REAL(DP), PARAMETER :: znu1cs(20) = [ +.203306756994191729674444001216911D+0, &
  ...
  REAL(DP), PARAMETER :: sqpi2 = +1.2533141373155002512078826424055D0
  REAL(DP), PARAMETER :: aln2 = 0.69314718055994530941723212145818D0
