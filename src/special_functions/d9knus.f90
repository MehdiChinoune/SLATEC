...
SUBROUTINE D9KNUS(Xnu,X,Bknu,Bknu1,Iswtch)
  ...
  REAL(8) :: Xnu, X, Bknu, Bknu1, alpha(32), beta(32), a(32), alnz, aln2, a0, &
    bknud, bknu0, b0, c0, euler, expx, p1, p2, p3, qq, result, sqpi2, sqrtx, v, &
    vlnz, xi, xmu, xnusml, xsml, x2n, x2tov, z, ztov, alnsml, alnbig
  REAL alneps
  INTEGER, EXTERNAL :: INITDS
  REAL(8), EXTERNAL :: D1MACH, DCSEVL, DGAMMA
  SAVE euler, sqpi2, aln2, ntc0k, ntznu1, xnusml, xsml, alnsml, alnbig, alneps
