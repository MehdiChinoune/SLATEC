...
REAL(SP) FUNCTION BIE(X)
  ...
  REAL(SP), PARAMETER :: eta = 0.1*R1MACH(3), x3sml = eta**0.3333, &
    x32sml = 1.3104*x3sml**2, xbig = R1MACH(2)**0.6666
  REAL(SP), PARAMETER :: bifcs(9) = [ -.01673021647198664948E0, .1025233583424944561E0, &
  ...
  REAL(SP), PARAMETER :: bigcs(8) = [ .02246622324857452E0, .03736477545301955E0, &
    .00044476218957212E0, .00000247080756363E0, .00000000791913533E0, &
    .00000000001649807E0, .00000000000002411E0, .00000000000000002E0 ]
  REAL(SP), PARAMETER :: bif2cs(10) = [ 0.09984572693816041E0, .478624977863005538E0, &
  ...
  REAL(SP), PARAMETER :: big2cs(10) = [ .033305662145514340E0, .161309215123197068E0, &
  ...
  REAL(SP), PARAMETER :: bipcs(24) = [ -.08322047477943447E0, .01146118927371174E0, &
    ...
    .00000000000000001E0 ]
  REAL(SP), PARAMETER :: bip2cs(29) = [ -.113596737585988679E0, .0041381473947881595E0, &
  ...
  REAL(SP), PARAMETER :: atr = 8.7506905708484345E0
