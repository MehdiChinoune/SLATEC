...
REAL(DP) FUNCTION D9ATN1(X)
  ...
  REAL(DP) :: y
  INTEGER, SAVE :: ntatn1
  REAL(DP), PARAMETER :: eps = D1MACH(3), xsml = SQRT(0.1D0*eps), &
    xbig = 1.571D0/SQRT(eps), xmax = 1.571D0/eps
  REAL(DP), PARAMETER :: atn1cs(40) = [ -.3283997535355202356907939922990D-1, &
