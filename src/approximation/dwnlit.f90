...
SUBROUTINE DWNLIT(W,Mdw,M,N,L,Ipivot,Itype,H,Scalee,Rnorm,Idope,Dope,Done)
  ...
  USE linear, ONLY : DCOPY, DH12, DROTM, DROTMG, DSCAL, DSWAP, IDAMAX
  ...
  DO i = 1, lb
    ...
    ir = i
    mend = M
    CALL DWNLT1(i,lend,M,ir,Mdw,recalc,imax,hbar,H,Scalee,W)
    !
    ...
    DO
      ...
      !
      IF ( DWNLT2(me,mend,ir,factor,tau,Scalee,W(1,i)) ) THEN
        !
  ...
  IF ( krank<me ) THEN
    ...
    DO i = L + 1, lb
      ...
      lend = N
      mend = me
      CALL DWNLT1(i,lend,me,ir,Mdw,recalc,imax,hbar,H,Scalee,W)
      !
      ...
      !
      IF ( .NOT.DWNLT2(me,mend,ir,factor,tau,Scalee,W(1,i)) ) THEN
        jj = ir
        DO ir = jj, me
          W(ir,1:N) = 0.D0
  ...
  IF ( krank<l1 ) THEN
    ...
    DO i = krank + 1, l1
      ...
      lend = L
      mend = M
      CALL DWNLT1(i,L,M,ir,Mdw,recalc,imax,hbar,H,Scalee,W)
      !
      !           Update column SS and find pivot column.
      !
      CALL DWNLT3(i,imax,M,Mdw,Ipivot,H,W)
