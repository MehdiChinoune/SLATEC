...
SUBROUTINE DDRIV2(N,T,Y,F,Tout,Mstate,Nroot,Eps,Ewt,Mint,Work,Lenw,Iwork,&
  ...
  ! **Category:**  I1A2, I1A1B
  !***
  ! **Type:**      DOUBLE PRECISION (SDRIV2-S, DDRIV2-D, CDRIV2-C)
  !***
  ...
  !  I.  PARAMETERS  .....................................................
  !
  !       (REMEMBER--To run DDRIV2 correctly in double precision, ALL
  ...
  !                  advancing TOUT and calling DDRIV2 again.
  ...
  !                  calling DDRIV2 again.  Otherwise the program will
  !                  terminate the run.
  !
  ...
  !               DOUBLE PRECISION EPS, EWT, T, TOUT, WORK(LENW), Y(N)
  !               INTEGER IWORK(LENIW)
