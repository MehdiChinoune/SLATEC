...
SUBROUTINE DSPLP(DUSRMT,Mrelas,Nvars,Costs,Prgopt,Dattrv,Bl,Bu,Ind,Info,&
  ...
  !     printed.  If IDIGIT<0, 72 printing columns are used.  If
  !     IDIGIT>0, 133 printing columns are used.
  ...
  !     by garbage.  Messages:
  !     DSPLP( ). VALUE OF MRELAS MUST BE >0. NOW=(I1).
  !               IN ABOVE MESSAGE, I1=         0
  !     ERROR NUMBER =         5
  !
  !     DSPLP( ). VALUE OF NVARS MUST BE >0. NOW=(I1).
  !               IN ABOVE MESSAGE, I1=         0
  !     ERROR NUMBER =         6
  !
  ...
  !     ERROR NUMBER =         20
  !
  !     DSPLP( ). USER-DEFINED VALUE OF LBM MUST BE >= 0.
  !     ERROR NUMBER =         21
  !
