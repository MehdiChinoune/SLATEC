!*==SSLUBC.f90  processed by SPAG 6.72Dc at 10:58 on  6 Feb 2019
!DECK SSLUBC
...
!         BiConjugate Gradient algorithm.
      CALL SBCG(N,B,X,Nelt,Ia,Ja,A,Isym,SSMV,SSMTV,SSLUI,SSLUTI,Itol,Tol,Itmax,
