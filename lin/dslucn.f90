!*==DSLUCN.f90  processed by SPAG 6.72Dc at 10:58 on  6 Feb 2019
!DECK DSLUCN
SUBROUTINE DSLUCN(N,B,X,Nelt,Ia,Ja,A,Isym,Itol,Tol,Itmax,Iter,Err,Ierr,&
  ...
  !***LIBRARY   SLATEC (SLAP)
  !***CATEGORY  D2A4, D2B4
  !***TYPE      DOUBLE PRECISION (SSLUCN-S, DSLUCN-D)
  ...
  !
  !***SEE ALSO  DCGN, SDCGN, DSILUS
  !***REFERENCES  (NONE)
  !***ROUTINES CALLED  DCGN, DCHKW, DS2Y, DSILUS, DSMMTI, DSMTV, DSMV
  ...
  CALL DCGN(N,B,X,Nelt,Ia,Ja,A,Isym,DSMV,DSMTV,DSMMTI,Itol,Tol,Itmax,Iter,&
